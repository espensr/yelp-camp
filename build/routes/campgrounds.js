...
var express = require("express"), router = express.Router(), Campground = require("../models/campground"), UserComment = require("../models/userComment"), middleware = require("../middleware"), NodeGeocoder = require("node-geocoder"), connect = require("connect-ensure-login");
...
// Update
router.put("/:id", middleware.checkCampgroundOwnership, middleware.geocodeData, (req, res) => {
...
router.delete("/:id", middleware.checkCampgroundOwnership, (req, res) => {
    Campground.findByIdAndRemove(req.params.id, (err, camggroundRemoved) => {
        if (err) {
            ...
            UserComment.deleteMany({ _id: { $in: camggroundRemoved.comments } }, (err) => {
                if (err) {
